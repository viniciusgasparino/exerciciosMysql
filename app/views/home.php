		...
		<fieldset class="home">
			...
			<fieldset class="alt p2">
				...
				<p>Seja bem vindo a jornada do programador</p>
					<div class="rows">
						<div class="col-6 p2">
							<a href="<?= URL_BASE . "area" ?>" class="btn">
								<i class="fas fa-shapes"></i> Ir Formas geométrica
							</a>
						</div>
						<div class="col-6 p2">
							<a href="<?= URL_BASE . "Cantor" ?>" class="btn">
								<i class="fas fa-th-list"></i> Ir para lista
							</a>
						</div>			
						<div class="col-6 p2">
							<a href="<?= URL_BASE . "cliente/cadastro" ?>" class="btn"> 
							 <i class="fas fa-plus-square"></i> Ir para Cadastro
							</a>
						</div>
						<div class="col-6 p2">
							<a href="<?= URL_BASE . "cliente/resultado" ?>" class="btn"> 
